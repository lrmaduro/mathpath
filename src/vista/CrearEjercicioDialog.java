...
public class CrearEjercicioDialog extends JDialog {
    ...
    public CrearEjercicioDialog(JFrame parent, List<String> temas) {
        ...
        btnGuardar.addActionListener(e -> {
            if (txtPregunta.getText().trim().isEmpty() || txtOpcionA.getText().trim().isEmpty()
                    || txtOpcionB.getText().trim().isEmpty() || txtOpcionC.getText().trim().isEmpty()
                    || txtOpcionD.getText().trim().isEmpty() || txtRetro.getText().trim().isEmpty()) {
                JOptionPane.showMessageDialog(CrearEjercicioDialog.this, "Por favor, completa todos los campos.",
    ...
    public Ejercicio getNuevoEjercicio() {
        ...
        List<String> opciones = Arrays.asList(txtOpcionA.getText(), txtOpcionB.getText(), txtOpcionC.getText(),
                txtOpcionD.getText());
