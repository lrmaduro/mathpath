...
public class ReportesView extends JPanel {
    ...
    public void cargarComboActividades(List<Actividad> actividades) {
        ...
        for (Actividad act : actividades)
            cmbActividades.addItem(act.getNombre());
    ...
    public void actualizarTabla(List<Object[]> datos, double promedio) {
        ...
        lblTotalAlumnos
                .setText("<html><div style='text-align:center;'>Total Registros<br><span style='font-size:18px;'>"
                        + datos.size() + "</span></div></html>");
        lblPromedio.setText("<html><div style='text-align:center;'>Nota Media<br><span style='font-size:18px;'>"
                + String.format("%.1f", promedio) + "</span></div></html>");
    }
    ...
    public void actualizarTabla(List<Object[]> datos) {
        ...
        lblPromedio.setText(
                "<html><div style='text-align:center;'>Nota Media<br><span style='font-size:12px;'>(Ver detalle)</span></div></html>");
    }

    // --- Estilos ---
    private void estilarCombo(JComboBox<String> cmb) {
    ...
    private JLabel crearTarjetaResumen(String titulo, String valor, Color colorFondo) {
        JLabel lbl = new JLabel("<html><div style='text-align:center;'>" + titulo + "<br><span style='font-size:18px;'>"
                + valor + "</span></div></html>");
        lbl.setOpaque(true);
    ...
    // Getters y Listeners
    public void addFiltroAulaListener(ActionListener al) {
        cmbAulas.addActionListener(al);
    }

    public void addFiltroActividadListener(ActionListener al) {
        cmbActividades.addActionListener(al);
    }
